...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(len(alphabet)):
            ...
            shift_dict[alphabet[i].upper()] = shifted_alphabet[i].upper()
        return shift_dict
        pass #delete this line and replace with your code here
...
if __name__ == '__main__':
    ...
    print("Best shift value used to decrypt the story:", ciphertext.decrypt_message()[0])
    print("Unencrypted story:")
    print(ciphertext.decrypt_message()[1])
